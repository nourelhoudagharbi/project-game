...
function hideCards() {
    for (let r = 0; r < rows; r++) {
        for (let c = 0; c < columns; c++) {
            ...
            card.src = "att.AW2rQHtHFjrDf9l6FiG8odwV4tal54YZuT6YGV7vWsk.jpg";
        }
    }
}

function selectCard() {
    if (this.src.includes("att.AW2rQHtHFjrDf9l6FiG8odwV4tal54YZuT6YGV7vWsk")) {
        if (!card1Selected) {
            card1Selected = this;
...
function update() {
    ...
    if (card1Selected.src != card2Selected.src) {
        card1Selected.src = "att.AW2rQHtHFjrDf9l6FiG8odwV4tal54YZuT6YGV7vWsk.jpg";
        card2Selected.src = "att.AW2rQHtHFjrDf9l6FiG8odwV4tal54YZuT6YGV7vWsk.jpg";
        errors += 1;
